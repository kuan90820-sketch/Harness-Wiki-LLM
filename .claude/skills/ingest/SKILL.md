---
name: ingest
description: 把一份新 source 整合進 wiki。觸發時機：使用者說「處理 raw/X」「ingest X」或明確要整合新資料進 wiki 時。
---
...
- 先讀根 [`CLAUDE.md`](../../../CLAUDE.md) 與 [`.claude/Docs/wiki-conventions.md`](../../Docs/wiki-conventions.md) 喚起公約。
...
- 套用 [`.claude/Docs/wiki-summaries.md`](../../Docs/wiki-summaries.md) 的模板。
