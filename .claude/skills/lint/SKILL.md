---
name: lint
description: 對整個 wiki 做健康檢查。觸發時機：使用者說「lint wiki」「健康檢查」或每累積一批新 source 後要全面審視 wiki 時。
---
...
> 請對 wiki 做一次健康檢查，或 `/lint`，或「lint wiki」。
...
沒有任何其他頁連到的頁面（不含 index.md / log.md / open-questions.md）：
```
