---
description: 對整個 wiki 做健康檢查 — 完整 SOP 在 prompts/lint.md（兩階段：機械化 W1–W4 + 語意 B1–B6，產出 lint 報告，不直接動手修）
---

# /lint — wiki 健康檢查

**完整 SOP 住在** [`prompts/lint.md`](../../prompts/lint.md)。請打開那份，**逐步驟跑完兩個階段**。
...
2. 讀 [`prompts/lint.md`](../../prompts/lint.md) 取得本次工作流的完整 SOP。
...
> 🔁 這份 workflow 是 Antigravity slash command 的薄殼。真正的邏輯在 `prompts/lint.md`，更新 SOP 時請改那一份，這裡不用動。
